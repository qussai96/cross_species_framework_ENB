...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--ibaq-intensities",
        default=None,
        help="Optional directory with *_mcIBAQ.intensities.tsv files",
    )
    ...
    parser.add_argument(
        "--output",
        default=None,
        help="Optional legacy output path; only its parent directory is used when --output-dir is not set",
    )
    parser.add_argument(
        "--output-raw",
        default=None,
...
def main() -> None:
    ...
    ibaq_output = output_dir / "protein_orthogroup_po_matrix_mcIBAQ_intensities.csv"
    ...
    build_matrix_fast(
        ...
        ibaq_dir=args.ibaq_intensities,
        output_ibaq=str(ibaq_output) if args.ibaq_intensities else None,
